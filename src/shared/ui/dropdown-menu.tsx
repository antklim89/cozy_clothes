...
function DropdownMenuSubContent({
  ...
  className,
  ...props
}: ComponentPropsWithoutRef<typeof SubContent> & { ref?: RefObject<ComponentRef<typeof SubContent>> }) {
  return (
    <SubContent
      className={cn(
...
function DropdownMenuLabel({
  ...
  return <Label className={cn('px-2 py-1.5 font-semibold text-sm', inset && 'pl-8', className)} ref={ref} {...props} />;
}
