...
function CardTitle({
  ...
  className,
  ...props
}: HTMLAttributes<HTMLHeadingElement> & { ref?: RefObject<HTMLParagraphElement> }) {
  return <h3 className={cn('font-semibold text-2xl leading-none tracking-tight', className)} ref={ref} {...props} />;
}
