...
function AlertTitle({
  ...
  className,
  ...props
}: HTMLAttributes<HTMLHeadingElement> & { ref?: RefObject<HTMLParagraphElement | null> }) {
  return <h5 className={cn('mb-1 font-medium text-lg leading-none tracking-tight', className)} ref={ref} {...props} />;
}
...
function AlertDescription({
  ...
  className,
  ...props
}: HTMLAttributes<HTMLParagraphElement> & { ref?: RefObject<HTMLParagraphElement | null> }) {
